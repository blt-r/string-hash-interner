...
criterion_group!(
    bench_intern,
    bench_intern_fill,
    bench_intern_fill_with_capacity,
    bench_intern_already_filled,
);
criterion_main!(bench_intern, bench_resolve, bench_get, bench_iter);

fn bench_intern_fill_with_capacity(c: &mut Criterion) {
...
fn bench_intern_fill(c: &mut Criterion) {
...
fn bench_intern_already_filled(c: &mut Criterion) {
